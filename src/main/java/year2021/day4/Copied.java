...
public class Copied {
    public static void main(String[] args) {
        Board b = getWinner(new File("src/main/java/year2021/day4/input.txt"));
        System.out.println(b.getScore());
        Board b2 = getLastWinning(new File("src/main/java/year2021/day4/input.txt"));
        System.out.println(b2.getScore());
    }
